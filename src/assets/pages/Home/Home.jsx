const Home = () => {
    return (
        <section className='md:max-w-130 lg:scale-125'>
            ...
            <section className='md:flex md:w-full'>
                <div className='bg-cyan-43 p-5 md:w-[50%] md:rounded-bl-sm'>
                ...
                <div className='bg-cyan-52 p-5 rounded-b-sm md:rounded-none md:w-[50%] md:rounded-br-sm'>
